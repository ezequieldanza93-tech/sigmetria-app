...
import type { AsistenciaDiaria, DirectorioPersona } from '@/lib/types'
...
export function AsistenciaTab({ establecimientoId, empresaId, canWrite }: AsistenciaTabProps) {
  ...
  return (
    <div>
      ...
      {registros === null ? (
        <div className="bg-white dark:bg-surface-elevated rounded-xl border border-gray-200 dark:border-border-subtle p-8 text-center text-gray-400 text-sm">Cargando…</div>
      ) : registros.length === 0 ? (
