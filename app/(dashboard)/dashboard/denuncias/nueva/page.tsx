...
import { createDenuncia } from '@/lib/actions/denuncia'
...
export default async function NuevaDenunciaPage() {
  ...
  return (
    <div className="p-4 sm:p-6 max-w-3xl mx-auto space-y-6">
      ...
      <div>
        <h1 className="text-xl font-semibold text-text-primary">Nueva Denuncia</h1>
        <p className="text-sm text-text-tertiary mt-0.5">
          Registrá un reclamo formal o reporte
        </p>
      </div>

      <Card padding="lg">
        <DenunciaForm
          action={createDenuncia}
          empresas={empresas}
