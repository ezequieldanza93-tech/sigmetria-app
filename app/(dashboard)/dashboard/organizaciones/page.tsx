    ...
    <div className="p-8 max-w-5xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Proveedores, subcontratistas, marcas y más</p>
        </div>
      ...
      <Modal open={showModal} onClose={() => setShowModal(false)} title="Nueva Organización">
        <OrganizacionForm
          tiposOrg={tiposOrg}
