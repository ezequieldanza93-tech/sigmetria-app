  ...
  return (
    <div className="p-8 max-w-5xl">
      <div className="mb-6">
        ...
        <p className="text-gray-500 text-sm mt-1">{members?.length ?? 0} usuario{members?.length !== 1 ? 's' : ''} en la consultora</p>
      </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
        <table className="w-full text-sm">
          ...
          <tbody className="divide-y divide-gray-50">
            {members?.map(m => {
              const profile = m.profiles as { full_name?: string; system_role?: string } | null
